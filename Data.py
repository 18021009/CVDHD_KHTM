...
def changeToDate(input_file, output_file):
...
# changeToDate('data.csv', 'data.csv')


# changeToDate('data.csv','buffer_1_data.csv')
# buffer_data('buffer_1_data.csv', 1)

# changeToDate('data.csv','buffer_2_data.csv')
# buffer_data('buffer_2_data.csv', 2)

# changeToDate('data.csv','buffer_3_data.csv')
