...
data = data.drop(["time", "lat", "long", "name"], axis=1)
...
# def selectedFeature(listSelectedFeature, listFeature):
#     r2OfFeature = []
#     oldX = data[listSelectedFeature]
#     oldModel = linear_model().fit(y_true, oldX)
#     oldYPredict = oldModel(oldX)
#     oldR2 = r2(y_true, oldYPredict)
#     for i in listFeature:
#         newListSelectedFeature = listSelectedFeature + i
#         newX = data[newListSelectedFeature]
#         newModel = linear_model().fit(y_true, newX)
#         newYPredict = newModel(newX)

#         newR2 = r2(y_true, newYPredict)

#         if(newR2 - oldR2 > 0.1):
#             r2OfFeature.append()

listFeature = ["wind_speed1", 'wind_speed2']

print(data[listFeature])
